...
* Xây dựng các API cho dữ liệu ingame.
...
* Các API quản lý user đã bắt đầu hoạt động đúng với luồng yêu cầu.
* Các API dữ liệu ingame đã được triển khai và kết nối với database.
* Các service đã được tích hợp vào project, chỉ còn vài lỗi nhỏ cần xử lý.
* Em đã sẵn sàng chuyển sang phần kiểm thử, sửa lỗi và tối ưu hiệu năng.
