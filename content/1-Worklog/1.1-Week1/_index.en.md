...
* Create the AWS account and complete the first credit tasks.
* Review the internship roadmap and the workshop materials.
* Confirm the project direction and start organizing the team.
...
* I completed the first AWS setup steps and felt comfortable using the console.
* The team agreed on the project direction and the first responsibilities were clear.
* The workshop notes gave me a better understanding of the cloud mindset for the internship.
* I finished the week with a clear plan for the next stage of learning and labs.
