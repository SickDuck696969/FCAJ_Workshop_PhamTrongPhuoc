...
On-site office work, backend API optimization, and performance tuning for the game API workshop.

### Week Objectives

* Work on-site at the AWS Vietnam office on June 1st.
* Collaborate with the team on performance optimizations and backend API refactoring.
...
| 04/06/2026 | Thursday | Refine the game API response path and optimize request payload processing for backend services. | API Optimization |
| 05/06/2026 | Friday | Debug integration issues and validate stable API behavior under network and load variations. | Integration Testing |
...
* Improve backend stability for the game API service.

### Week 7 References

* [Project Repository](https://github.com/SuKem0703/BNGROUP_GAMEAPI) — Game Backend API
* AWS Services: EC2, RDS MySQL, ElastiCache Redis, API Gateway
