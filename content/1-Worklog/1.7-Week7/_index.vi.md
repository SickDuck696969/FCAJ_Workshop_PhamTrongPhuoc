...
* Nghiên cứu các dịch vụ AWS cần thiết cho [SuKem0703/BNGROUP_GAMEAPI](https://github.com/SuKem0703/BNGROUP_GAMEAPI).
* Thiết kế kiến trúc hệ thống cho project game backend.
* Xác định cách các service chính sẽ giao tiếp với nhau.
...
* Kiến trúc cho project game backend đã được xác định khá rõ ràng.
* Em hiểu các dịch vụ AWS cần dùng và cách chúng phối hợp với nhau.
* Ghi chú trong repo [SuKem0703/BNGROUP_GAMEAPI](https://github.com/SuKem0703/BNGROUP_GAMEAPI) đã được cập nhật theo các quyết định thiết kế mới nhất.
* Project đã sẵn sàng chuyển sang giai đoạn cấu hình AWS và triển khai database.
