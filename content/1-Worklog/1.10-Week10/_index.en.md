...
* Complete the remaining APIs.
* Test the project and fix bugs.
* Improve the performance where needed.
...
* The APIs were completed and the project was tested more thoroughly.
* The main bugs were fixed and the user flow became more stable.
* The slower sections were improved after the optimization pass.
* The project was ready for deployment and workshop preparation.
