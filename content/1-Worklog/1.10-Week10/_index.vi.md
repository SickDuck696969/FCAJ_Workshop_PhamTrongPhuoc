...
* Hoàn thiện các API còn lại.
* Kiểm thử project và sửa lỗi.
* Tối ưu hiệu năng ở những phần cần thiết.
...
* Các API đã được hoàn thiện và project được kiểm thử kỹ hơn.
* Những lỗi chính đã được sửa và luồng người dùng ổn định hơn.
* Các phần chậm đã được cải thiện sau khi tối ưu.
* Project đã sẵn sàng cho bước deploy và chuẩn bị workshop.
